...
AUDIO_FILE="/data/data/com.termux/files/home/maycolai_music.m4a"

# Descargar la música si no existe
if [ ! -f "$AUDIO_FILE" ]; then
    echo -e "$YellowDescargando música de fondo...$Reset"
    curl -L "$AUDIO_URL" -o "$AUDIO_FILE"
fi

# Reproducir la música de fondo en segundo plano
...
# Detener la música antes de iniciar el bot
